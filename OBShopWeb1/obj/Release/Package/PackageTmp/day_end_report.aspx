<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="day_end_report.aspx.cs" Inherits="OBShopWeb.day_end_report" %>
...
<body>
    ...
    <form runat="server">
        <asp:Label ID="ResultLabel" runat="server" Text="" ForeColor="Red"></asp:Label><br/>  
         <asp:Button ID="PrintBtn" runat="server" Text="列印日結報表" OnClick="PrintBtn_Click" /> <br/> 
        <br/>  
    </form>
   <%-- <p>日期選擇: <input type="text" id="datepicker" name="Date" /></p>--%>
