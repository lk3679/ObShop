<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryNumOne.aspx.cs" Inherits="OBShopWeb.PDA.InventoryNumOne" %>
...
<body>
    ...
    <div>
    <span class="style1"><strong>盤點(單一品項)</strong></span>
    <br />
    ...
    <hr />
    <span class="style13PDA" style="color: #990099">盤點產品：</span>
    <asp:Label ID="lbl_ProductName" runat="server" CssClass="style13PDA" ForeColor="#990099"></asp:Label>
    <br />
